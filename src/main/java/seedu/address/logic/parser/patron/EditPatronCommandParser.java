...
/**
 * Parses input arguments and creates a new EditPatronCommand object
 */
public class EditPatronCommandParser implements Parser<EditPatronCommand> {
     ...
     */
    public EditPatronCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        try {
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                    EditPatronCommand.MESSAGE_USAGE), pe);
        }
        ...
        if (!editPersonDescriptor.isAnyFieldEdited()) {
            throw new ParseException(EditPatronCommand.MESSAGE_NOT_EDITED);
        }

        return new EditPatronCommand(index, editPersonDescriptor);
    }
